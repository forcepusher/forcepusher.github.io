...
var ASM_CONSTS = {
  2779344: function() {return Module.webglContextAttributes.premultipliedAlpha;},  
 2779405: function() {return Module.webglContextAttributes.preserveDrawingBuffer;},  
 2779469: function() {return Module.webglContextAttributes.powerPreference;},  
 2779527: function() {Module['emscripten_get_now_backup'] = performance.now;},  
 2779582: function($0) {performance.now = function() { return $0; };},  
 2779630: function($0) {performance.now = function() { return $0; };},  
 2779678: function() {performance.now = Module['emscripten_get_now_backup'];}
};
  ...
  var webInputBridge = {keyboardDeviceType:0,gamepadDeviceType:1,onButtonPressCallbackPtr:undefined,onButtonReleaseCallbackPtr:undefined,registeredKeyboardButtons:{},registeredGamepadButtons:{},previousGamepadButtonStates:{},initialize:function (onButtonPressCallbackPtr, onButtonReleaseCallbackPtr) {
        ...
        (function(a1, a2) {  dynCall_vii.apply(null, [callbackPtr, a1, a2]); })(webInputDeviceType, webKeyCode);
      }};
  function _WebInputBridgeInitialize(onButtonPressCallbackPtr, onButtonReleaseCallbackPtr) {
      webInputBridge.initialize(onButtonPressCallbackPtr, onButtonReleaseCallbackPtr);
    }

  function _WebInputBridgePollInput() {
      webInputBridge.pollGamepadInput();
    }

  function _WebInputBridgeRegisterButton(webInputDeviceType, webKeyCode) {
...
var asmLibraryArg = {
  ...
  "WebInputBridgeInitialize": _WebInputBridgeInitialize,
  "WebInputBridgePollInput": _WebInputBridgePollInput,
  "WebInputBridgeRegisterButton": _WebInputBridgeRegisterButton,
...
unexportedRuntimeFunction('webInputBridge', false);
unexportedRuntimeFunction('webInputBridge__user', false);
